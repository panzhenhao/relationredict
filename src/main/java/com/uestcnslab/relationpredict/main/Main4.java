...
public class Main4 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String filename2 = path + "data/train_core_skip200_classify_cluster_5.csv";
        List<ClusterModel> ClusterModels2 = CsvFileUtil.loadClusterModel(filename);
        ...
        List<WordVecPoint> relationVec = WordVecModelTransferUtil.getRelationVec(testSet,
            cbowModel);
        List<WordVecPoint> relationVec2 = WordVecModelTransferUtil.getRelationVec(testSet,
            skipModel);

        //５.计算结果
        Map<Integer, List<SimilarModel>> mapResult = calculateSimilar(ClusterModels, relationVec);
        Map<Integer, List<SimilarModel>> mapResult2 = calculateSimilar(ClusterModels2, relationVec2);
        ...
        for (String key : Result.keySet()) {
            ...
            System.out.println(key + "准确率： " + acc);
            System.out.println(key + "召回率： " + recall);
            System.out.println(key + "f1值： " + f1_Measure);
        }
        //
    }
