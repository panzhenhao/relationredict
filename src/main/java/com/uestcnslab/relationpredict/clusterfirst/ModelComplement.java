...
public class ModelComplement {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //2.加载训练集聚类模型
        String filename = path + "cluster-first-data/train_all_cbow200_40.csv";
        List<AttributeModel> attributeModes = CsvFileUtil.loadClusterRelationModel(filename);
        logger.info("第二阶段：训练集聚类模型加载完成！");
        
        //3 加载聚类中心
        filename = path + "cluster-first-data/train_core_cbow200_40.csv";
        ...
        //5 完整数据模型
        filename = System.getProperty("user.dir")+"/src/main/resources/cluster-first-data/train_cbow200_40_all.csv";
