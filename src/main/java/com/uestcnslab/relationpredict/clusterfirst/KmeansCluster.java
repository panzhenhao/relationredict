...
public class KmeansCluster {
	...
	public static void main(String[] args) throws Exception {
		...
		// ４.1聚类
		List<WordVecRelationModel[]> clusterResult = useKmeans(relationVec, 25);
		logger.info("第四阶段：聚类模型计算完成！");
		
		// ５.回写文件
		filename = System.getProperty("user.dir")+"/src/main/resources/cluster-first-data/train_core_cbow200_25.csv";
		writeDataClusterToCsv(filename, clusterResult.get(0));
		logger.info("第五阶段1：聚类中心文件csv完成！");
		filename = System.getProperty("user.dir")+"/src/main/resources/cluster-first-data/train_all_cbow200_25.csv";
